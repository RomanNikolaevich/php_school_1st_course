...
// разберем на примере авторизации на сайте (html код закоментим, чтобы не мешал, но на странице сайта он должен
// быть не закоментен):
...
/*Мини-игра, цель которой показать, что алкоголизм - это плохо. Мы создаём страничку game.php под игру.
...
<div>
	<div><b><?php echo $row['title']; ?></b> <!--вывод заглавия-->
		<span style="color:#5c636a; font-size:10px;"><?php $row['date'] ?></span></div> <!-- и даты, серым-->
</div>
<?php } ?>
</div>
...
<div>
	<form action="" method="post">
		<input type="text" name="" value="">
			...
			<div>
				Описание новости:
				<textarea name="discription"></textarea> <!--name соотвествует разделу в БД-->
			</div>
			<div>
