...
18-7// Домашка
//Сделать БД: 1)"Пользователи" - туда внести "имя", "возраст/год рождения", "дата создания своего аккаунта", логин, пароль, краткую информацию о себе. Лучше всего посмотреть по разным сайтам какие поля заполняюься при регистрации.
