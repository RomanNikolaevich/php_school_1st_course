...
<?php
14-11 //Какой цикл быстрее и почему?
foreach //- используется для обхода массива! Он быстрее всего обходит массив.
for //- используется для счетчика, сделать какое-то определенное количество раз определенное действие. Для данного случая будет быстрее for.
while //- пока удовлетворяется условие выполнять цикл. Для этого лучше while.
