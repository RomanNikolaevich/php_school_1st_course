...
/*  5) $_COOKIE;
	...
	7) $_ENV; - не будем вообщше разбирать.
	8) $_SERVER;
	9) $_GLOBALS; - сегодня рассматривать не будем
расмотрим $_SERVER: */
echo '<pre>'.print_r($_SERVER,1).'</pre>'; // получаем полную информацию
// о сервере. Данную переменную в коде осталять нельзя, чтобы не отдасть хакерам наш
...
16-14// Домашнее задание №1 Форму для авторизации и выход
https://youtu.be/xxTMusbYpIk?t=4200

16-15// Домашнее задание №2 Битва алкоголиков

16-16// Домашнее задание №3 Файловый менеджер
?>
